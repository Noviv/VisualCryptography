...
public class PixelDistribution {
    ...
    public void setPositionFeeds(int x, int y, double nSignal, double eSignal, double wSignal, double sSignal) {
        boolean shift = false;
        signals[x][y] = new Signal(nSignal, eSignal, wSignal, sSignal, shift);
        pS = signals[x][y];
...
//                }
    ...
    public class Signal {
        ...
        private final boolean possibleShift;

        public Signal(double n, double e, double w, double s, boolean shift) {
            north = n;
            east = e;
            west = w;
            south = s;
